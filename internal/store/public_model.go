...
func (prd *ProductModel) ToSqlMap() map[string]interface{} {
	units, _ := json.Marshal(prd.Units)
	return map[string]interface{}{
		"union_id":                  prd.UnionId,
		"avatar":                    prd.Avatar,
		"cover":                     prd.Cover,
		"sn":                        prd.Sn,
		"name":                      prd.Name,
		"pinyin":                    prd.Pinyin,
		"brand_name":                prd.BrandName,
		"feature":                   prd.Feature,
		"price":                     prd.Price,
		"spec":                      prd.Spec,
		"spec_name":                 prd.SpecName,
		"spec_weight":               prd.SpecWeight,
		"pk_amount":                 prd.PkAmount,
		"pk_weight":                 prd.PkWeight,
		"pack_name":                 prd.PackName,
		"keep_life":                 prd.KeepLife,
		"keep_life_unit":            prd.KeepLifeUnit,
		"storage_conditions":        prd.StorageConditions,
		"transportation_conditions": prd.TransportationConditions,
		"unit":                      prd.Unit,
		"habitat":                   prd.Habitat,
		"style":                     prd.Style,
		"style_type":                prd.StyleType,
		"units":                     string(units),
		"status":                    1,
		"intime":                    utils.UnixTime(),
	}
}

// 判断是否相等
func (prd *ProductModel) Equal(productModel *ProductModel) bool {
	return prd.Name == productModel.Name &&
		prd.BrandName == productModel.BrandName &&
		prd.Spec == productModel.Spec &&
		prd.SpecName == productModel.SpecName &&
		prd.SpecWeight == productModel.SpecWeight &&
		prd.PkAmount == productModel.PkAmount &&
		prd.PackName == productModel.PackName &&
		prd.KeepLife == productModel.KeepLife &&
		prd.KeepLifeUnit == productModel.KeepLifeUnit &&
		prd.Style == productModel.Style &&
		prd.StyleType == productModel.StyleType
}
